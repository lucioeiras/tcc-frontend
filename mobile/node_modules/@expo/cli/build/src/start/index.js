#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/diegoeiras/.vscode/extensions/wallabyjs.console-ninja-1.0.525/out/buildHook/index.js').default({tool: 'react-native', checkSum: '2007790f51403e4613114aBQMZCR5UBgtSVgBRDQRTUAUIV1gE', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/diegoeiras/.vscode/extensions/wallabyjs.console-ninja-1.0.525/out/buildHook/index.js').then(m => m.default.default({tool: 'react-native', checkSum: '2007790f51403e4613114aBQMZCR5UBgtSVgBRDQRTUAUIV1gE', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
const expoStart = async (argv)=>{
    ...
    const { setNodeEnv, loadEnvFiles } = await Promise.resolve().then(()=>/*#__PURE__*/ _interop_require_wildcard(require("../utils/nodeEnv.js")));
    ...
    if (options.offline) {
        const { disableNetwork } = await Promise.resolve().then(()=>/*#__PURE__*/ _interop_require_wildcard(require("../api/settings.js")));
        disableNetwork();
    }
    const { startAsync } = await Promise.resolve().then(()=>/*#__PURE__*/ _interop_require_wildcard(require("./startAsync.js")));
